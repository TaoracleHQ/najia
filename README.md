...
以 ctext.org 的《周易》电子文本为参照底本（其版本记为 **武英殿十三經注疏**），对 61 卦逐字比对。剩余 3 卦（雷山小过、水火既济、火水未济）因 ctext 限流未取到，尚未比对。

比出 34 处单字差异。**判定方法不是凭印象，而是看本库内部的平行文句**：同一句在多处出现且用字一致，说明是来源一贯的用字（异文或简化），不予改动；若某处与库内其他地方自相矛盾，才是抄错。

据此改动 7 处（6 卦），每处都同时具备底本读法与本库内部证据：

| 卦 | 原 | 改为 | 依据 |
| --- | --- | --- | --- |
| 乾为天 | 见龙**再**田 | 见龙**在**田 | 「再田」不成词，底本明确；再/在 语义无关，非异文关系 |
| 山水蒙 | 初噬告 | 初筮告 | 库内另有「筮」2 处，来源识得此字（2 处） |
| 山天大畜 | 童豕之牿 | 童牛之牿 | 库内「牛」13 处；牿为牛栏，九五另作「豮豕之牙」 |
| 山风蛊 | 干父小有晦 | 干父之蛊，小有悔 | 其余各爻均作「干父之蛊」，此处脱字且错字 |
| 山火贲 | 小利有所往 | 小利有攸往 | 库内「利有攸往」22 处，此处孤例 |
| 水风井 | 有孚无吉 | 有孚元吉 | 「无吉」不成词，损卦作「有孚，元吉」 |

### 未改动的差异

其余 27 处判为来源一贯的用字或公认异文，**保持原样**，例如：

- **见 / 覿**、**只 / 祗**、**他 / 它**、**已 / 巳** —— 全库统一，属系统性简化
- **夤 / 彙** —— 泰卦、否卦平行句均作「夤」，来源一贯
- **己 / 巳**（革卦「己日乃孚」）、**亨 / 享**（困卦） —— 学界公认异文
- **逵 / 陸**（渐卦上九） —— 九三已作「鸿渐于陆」，若上九亦作「陸」则两爻重复，**此处我们的读法反而更可取**

### 仍然存在的问题

现在的状态是：**文本来源仍是采集自命理网站，已按 ctext 底本校出并修正 7 处不成词或自相矛盾的错讹。**这不等于全文已校勘。

- 未比对的 3 卦（雷山小过、水火既济、火水未济）可能仍有同类错讹
- 判定依赖"是否与库内其他地方自相矛盾"，孤立出现且尚能读通的错字查不出来
- 标点与分段沿用采集来源，未按底本规范

**根本解是按一个明确底本整体替换全部卦辞文本**，并在此注明所依据的版本。若卦辞要直接呈现给用户，建议做这一步。
